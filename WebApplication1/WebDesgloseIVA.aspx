<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WebDesgloseIVA.aspx.vb" Inherits="WebApplication1.WebDesgloseIVA" %>
...
&nbsp;&nbsp;&nbsp;&nbsp; Tipo de IVA: <asp:DropDownList ID="DropDownList1" runat="server" style="margin-bottom: -5px">
                ...
                <asp:ListItem Value="Superreducido">Superreducido</asp:ListItem>
            </asp:DropDownList>
            <br />
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
